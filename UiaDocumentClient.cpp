  ...
  switch (uMsg) {
    case WM_PAINT:
      ...
      switch (uFormat) {
        case CF_OWNERDISPLAY:
          ...
          lpps = static_cast<LPPAINTSTRUCT>(GlobalLock(hglb));
        ...
        case CF_TEXT:
          if (OpenClipboard(hwnd)) {
            ...
            lpstr = static_cast<LPSTR>(GlobalLock(hglb));
        ...
        case CF_ENHMETAFILE:
          if (OpenClipboard(hwnd)) {
            hemf = static_cast<HENHMETAFILE>(GetClipboardData(uFormat));
            GetClientRect(hwnd, &rc);
    ...
    case WM_SIZE:
      if (uFormat == CF_OWNERDISPLAY) {
        ...
        lprc = static_cast<LPRECT>(GlobalLock(hglb));
